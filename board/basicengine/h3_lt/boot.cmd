...
if fatload mmc 0 $fdt_addr_r $menu_dtb ; then
	...
	setenv bootmenu_15 NanoPi R1=setenv menu_dtb sun8i-h3-nanopi-r1.dtb
	setenv bootmenu_16 Revision DVK=setenv menu_dtb sun8i-h3-rervision-dvk.dtb
	setenv bootmenu_17 ZeroPi=setenv menu_dtb sun8i-h3-zeropi.dtb
	setenv bootmenu_18 Orange Pi R1=setenv menu_dtb sun8i-h2-plus-orangepi-r1.dtb
	setenv bootmenu_19 Orange Pi Zero=setenv menu_dtb sun8i-h2-plus-orangepi-zero.dtb
	bootmenu 99
	saveenv
